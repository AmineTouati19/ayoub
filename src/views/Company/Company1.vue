...
<template>
  ...
  <div class="search-container">
    ...
    <button type="submit">Search</button>
      ...
      <div class="hero">
        <button href="Form1" @click="log" class="add-button">
          <router-link :to="{ name: 'Form1' }"></router-link><i class="fas fa-plus"></i>
        </button>
      </div>
    </div>
    <div class="squares-container">
      ...
      <div class="square">
        ...
        <div class="square-content">
          ...
          <button class="btn1" @click="deleteSquare(index)">Delete</button>
        </div>
      </div>
    </div>
  </div>
